...
type ProductServiceClient interface {
	...
	ListProducts(ctx context.Context, in *ListProductRequest, opts ...grpc.CallOption) (*ListProoductResponse, error)
...
func (c *productServiceClient) ListProducts(ctx context.Context, in *ListProductRequest, opts ...grpc.CallOption) (*ListProoductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListProoductResponse)
...
func (c *productServiceClient) CreateProducts(ctx context.Context, in *CreateProductRequest, opts ...grpc.CallOption) (*CreateProductResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ProductServiceServer interface {
	...
	ListProducts(context.Context, *ListProductRequest) (*ListProoductResponse, error)
...
func (UnimplementedProductServiceServer) ListProducts(context.Context, *ListProductRequest) (*ListProoductResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListProducts not implemented")
}
func (UnimplementedProductServiceServer) CreateProducts(context.Context, *CreateProductRequest) (*CreateProductResponse, error) {
...
func _ProductService_CreateProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).CreateProducts(ctx, req.(*CreateProductRequest))
	}
	return interceptor(ctx, in, info, handler)
}
